...
1. WHEN 사용자가 회원가입을 시도하면 THEN 시스템은 네이버, 카카오, 구글, GitHub 소셜 로그인을 제공해야 합니다
...
1. WHEN 사용자가 프로젝트 아이디어를 공유하면 THEN 시스템은 다른 사용자들이 실시간으로 댓글과 제안을 달 수 있는 협업 공간을 제공해야 합니다
...
1. WHEN 사용자가 프로젝트 유형을 입력하면 THEN 시스템은 웹앱(Lovable), 모바일앱(Bolt.new), 올인원(Vitara.ai), 전문개발(Cursor) 등으로 도구를 추천해야 합니다
