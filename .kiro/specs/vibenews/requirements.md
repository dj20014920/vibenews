...
### 요구사항 4: 통합 검색 및 스크랩 시스템 [일부 완료]

**사용자 스토리:** 사용자로서, 뉴스, 커뮤니티, 댓글을 통합 검색하고, 마음에 드는 콘텐츠를 스크랩하여 나중에 다시 찾아볼 수 있기를 원합니다.

> **구현 노트:**
> - **완료:** 뉴스 검색에 대한 백엔드 성능을 Full-Text Search로 최적화했습니다. 북마크(스크랩) 기능 및 '마이페이지'에서 스크랩 목록을 볼 수 있는 기능을 구현했습니다.
> - **미완료:** 현재 검색 최적화는 뉴스에만 적용되어 있으며, 커뮤니티/댓글을 포함한 통합 검색 UI 및 로직은 추가 구현이 필요합니다. 또한 북마크에 대한 폴더 관리, 메모 등 고급 기능은 구현되지 않았습니다.
